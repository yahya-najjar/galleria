<!--begin::Subheader-->
<div class="subheader py-3 py-lg-8 subheader-transparent" id="kt_subheader" style="padding-top: 0px !important;padding-bottom: 0px!important;">
            ...
            <div class="d-flex align-items-baseline mr-5">
                ...
                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold my-2 p-0">
                    ...
                    <li class="breadcrumb-item">
                        ...
                        @else
                            <a href="#" class="text-muted">{{ __('admin.'.$item) }}</a>
                        @endif
                    </li>
                    {{ $slot }}
                </ul>
